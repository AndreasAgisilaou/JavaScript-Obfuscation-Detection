"""Trains an XGBoost classifier to detect obfuscated JavaScript files, using
the same hand-crafted lexical/statistical heuristics as random_forest.py, and
saves it (bundled with its scaler) to detection/models/xgboost/<model_name>.pkl.
"""
import os
...
try:
    ...
    # Allows running this file directly (e.g. `python xgboost_model.py` from
...
MODELS_DIR = os.path.join(PACKAGE_DIR, "models", "xgboost")
...
def train_model(dataset, model_name):
    ...
    bundled together, to models/xgboost/<model_name>.pkl."""
